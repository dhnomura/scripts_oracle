...
-- File Name    : 
-- Author       : Diogo Nomura
-- Description  : Creates the DDL for package
-- Call Syntax  : @ddl_packages.sql
...
begin
select 'backup_package_&&OWNER'||'_'||a.host_name||'_'||a.instance_name||'_'||to_char(sysdate,'YYYY_MM_DD_HH24_MI_SS')||'.sql' into :var1
from v$instance a,
dual b;
end;
/
