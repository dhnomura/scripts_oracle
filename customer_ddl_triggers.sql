...
-- Call Syntax  : @ddl_trigger
-- Last Modified: 16/03/2013 - Rewritten to use DBMS_METADATA
--              : 26/03/2022 - Diogo Nomura - Filter for a single user
--                                          - Include spool
-- -----------------------------------------------------------------------------------
...
begin
select 'backup_triggers_&&OWNER'||'_'||a.host_name||'_'||a.instance_name||'_'||to_char(sysdate,'YYYY_MM_DD_HH24_MI_SS')||'.sql' into :var1
from v$instance a,
dual b;
end;
/
